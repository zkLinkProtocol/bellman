...
// use crate::plonk::better_better_cs::proof::;
use crate::plonk::better_better_cs::proof::utils::*;
use crate::plonk::better_better_cs::proof::lookup_tables::LookupQuery;
use crate::plonk::better_better_cs::proof::cs::*;
use super::async_prover_new::Proof;
...
pub fn aggregate<E: Engine, C: Circuit<E>, T: Transcript<E::Fr>>(
    ...
    let queries_with_linearization = sort_queries_for_linearization_new(&sorted_gates, MAX_DILATION);
