...
impl<E: Engine, P: PlonkConstraintSystemParams<E>, MG: MainGate<E>, S: SynthesisMode> Assembly<E, P, MG, S> {
    ...
    pub fn new_for_size(size: usize) -> Self {
        ...
        let mut tmp = Self {
            ...
            input_assingments: Vec::with_capacity(size),
            aux_assingments: Vec::with_capacity(size),
    ...
    pub fn prover_stub(self, worker: &Worker) -> Result<(), SynthesisError> {
        ...
        let mut lookup_data: Option<super::super::lookup_tables::LookupDataHolder<E>> = if self.tables.len() > 0 {
            ...
            let data = super::super::lookup_tables::LookupDataHolder::<E> {
                eta,
