...
impl<E: Engine> AssembledPolynomialStorage<E> {
    fn get_poly(&self, id: PolyIdentifier) -> &Polynomial<E::Fr, Values> {
        match id {
    ...
    fn get_poly_at_step(&self, id: PolyIdentifier, step: usize) -> E::Fr {
...
impl<E: Engine, P: PlonkConstraintSystemParams<E>, MG: MainGate<E>> TrivialAssembly<E, P, MG> {
    ...
    fn make_assembled_poly_storage(&self, worker: &Worker) -> Result<AssembledPolynomialStorage<E>, SynthesisError> {
