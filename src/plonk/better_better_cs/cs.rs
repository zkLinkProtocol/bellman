...
pub use super::width4_main_gate_with_dnext::*;
pub use super::selector_optimized_width4_main_gate::*;
...
pub struct MainGateTerm<E: Engine>{
    pub terms: Vec<ArithmeticTerm<E>>,
    pub vars_scratch: std::collections::HashMap<Variable, usize>,
    pub num_multiplicative_terms: usize,
    pub num_constant_terms: usize
}
...
pub struct SimpleBitmap(u64, usize);
impl SimpleBitmap {
    pub fn new() -> Self {
        Self(0u64, 0)
    }

    pub fn get_next_unused(&mut self) -> usize {
        for i in 0..64 {
            if self.get(i) == false {
                return i;
            }
...
impl<E: Engine, P: PlonkConstraintSystemParams<E>, MG: MainGate<E>, S: SynthesisMode> Assembly<E, P, MG, S> {
    ...
    pub fn prover_stub(self, worker: &Worker) -> Result<(), SynthesisError> {
        ...
        for p in sorted_opening_requests.into_iter() {
            ...
            query_values_map.insert(p.clone(), value);
