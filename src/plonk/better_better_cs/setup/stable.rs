...
pub struct SetupPrecomputations<E: Engine, C: Circuit<E>> {
    ...
    pub lookup_selector_values: Option<Polynomial<E::Fr, Values>>,
    pub lookup_tables_values: Vec<Polynomial<E::Fr, Values>>,
    pub lookup_table_type_values: Option<Polynomial<E::Fr, Values>>,
...
impl<E: Engine, C: Circuit<E>> SetupPrecomputations<E, C> {
    ...
    ) -> Result<SetupPrecomputations<E, C>, SynthesisError> {
        let mut new = SetupPrecomputations::<E, C> {
            gate_setup_ldes: vec![],
            gate_selectors_ldes: vec![],
            permutation_ldes: vec![],
